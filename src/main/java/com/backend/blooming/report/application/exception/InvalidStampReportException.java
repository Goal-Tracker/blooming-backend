...
public class InvalidStampReportException extends BloomingException {
    ...
    public static class AlreadyReportStampException extends BloomingException {
    ...
    public static class NotAllowedReportOwnStampException extends BloomingException {
