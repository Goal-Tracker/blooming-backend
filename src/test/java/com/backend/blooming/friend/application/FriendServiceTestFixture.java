...
public class FriendServiceTestFixture {
    ...
    void setUpFixture() {
        ...
        final Friend 친구_요청1 = new Friend(친구_요청을_보낸_사용자, 이미_친구_요청을_받은_사용자);
        final Friend 친구_요청2 = new Friend(친구_요청을_보낸_사용자, 친구_요청을_받은_사용자2);
        final Friend 친구_요청3 = new Friend(친구_요청을_보낸_사용자, 친구_요청을_받은_사용자3);
        friendRepository.saveAll(List.of(친구_요청, 친구_요청1, 친구_요청2, 친구_요청3));

        친구_요청_아이디 = 친구_요청.getId();

        final ReadFriendsDto 요청한_친구_목록_dto = ReadFriendsDto.from(List.of(친구_요청1, 친구_요청2, 친구_요청3));
