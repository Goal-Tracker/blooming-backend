...
include::{snippets}/friend-controller-test/친구_요청한다/path-parameters.adoc[]
==== 응답
include::{snippets}/friend-controller-test/친구_요청한다/http-response.adoc[]

=== 친구 요청을 보낸 사용자 목록 조회
==== 요청
include::{snippets}/friend-controller-test/친구_요청을_보낸_사용자_목록을_조회한다/http-request.adoc[]
include::{snippets}/friend-controller-test/친구_요청을_보낸_사용자_목록을_조회한다/request-headers.adoc[]
==== 응답
include::{snippets}/friend-controller-test/친구_요청을_보낸_사용자_목록을_조회한다/http-response.adoc[]
include::{snippets}/friend-controller-test/친구_요청을_보낸_사용자_목록을_조회한다/response-fields.adoc[]

=== 친구 요청을 받은 사용자 목록 조회
==== 요청
include::{snippets}/friend-controller-test/친구_요청을_받은_사용자_목록을_조회한다/http-request.adoc[]
include::{snippets}/friend-controller-test/친구_요청을_받은_사용자_목록을_조회한다/request-headers.adoc[]
==== 응답
include::{snippets}/friend-controller-test/친구_요청을_받은_사용자_목록을_조회한다/http-response.adoc[]
include::{snippets}/friend-controller-test/친구_요청을_받은_사용자_목록을_조회한다/response-fields.adoc[]

=== 서로 친구인 사용자 목록 조회
==== 요청
include::{snippets}/friend-controller-test/서로_친구인_사용자_목록을_조회한다/http-request.adoc[]
include::{snippets}/friend-controller-test/서로_친구인_사용자_목록을_조회한다/request-headers.adoc[]
==== 응답
include::{snippets}/friend-controller-test/서로_친구인_사용자_목록을_조회한다/http-response.adoc[]
include::{snippets}/friend-controller-test/서로_친구인_사용자_목록을_조회한다/response-fields.adoc[]
...
include::{snippets}/friend-controller-test/친구_요청을_수락한다/path-parameters.adoc[]
==== 응답
include::{snippets}/friend-controller-test/친구_요청을_수락한다/http-response.adoc[]

=== 친구 요청 거절/취소
==== 요청
include::{snippets}/friend-controller-test/친구_요청을_거절한다/http-request.adoc[]
include::{snippets}/friend-controller-test/친구_요청을_거절한다/request-headers.adoc[]
include::{snippets}/friend-controller-test/친구_요청을_거절한다/path-parameters.adoc[]
==== 응답
include::{snippets}/friend-controller-test/친구_요청을_거절한다/http-response.adoc[]
